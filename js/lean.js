(function (xpath) {
  ...
  // Filter that removes all properties that use default browser values.
	...
	function getFirstElementByXpath(path) {
  ...
  // Making & processing snippets
	...
	// Tailor-made code starts here

	var element = getFirstElementByXpath(xpath);
	if (!element) {
		return null;
	}
	return processSnapshot(JSON.parse(Snapshooter(element)));
